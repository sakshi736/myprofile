    ...
    <section id="skills" style={{ padding: "5rem 0" }}>
      ...
      <div style={{
        ...
        {props.skillLists.map((list, i) => {
          const isAI =
            list.title.toLowerCase().includes("ai") ||
            list.title.toLowerCase().includes("claude")
            ...
            >
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: "1.25rem" }}>
                ...
                <div>
                  ...
                  <div style={{ fontSize: 11, color: "rgba(232,230,240,0.35)" }}>
                    {list.subtitle}
                  </div>
                </div>
              </div>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                {list.skills.map((skill, j) => (
                  <div key={j} style={{ display: "flex", alignItems: "center", gap: 10 }}>
                    <Icon
                      icon={skill.icon}
                      style={{ fontSize: 20, flexShrink: 0, width: 24 }}
                    />
                    <span style={{
                      fontSize: 13,
                    ...
                    {/* Skill bar */}
                    <div style={{
                      width: 56, height: 2, borderRadius: 2,
